...
<footer class="bg-gradient-to-br from-blue-900 to-purple-800 text-white relative overflow-hidden">
    ...
    <div
        class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
        ...
        <div class="lg:col-span-1">
            <div class="flex flex-col space-y-6">
                ...
                <div class="flex items-center space-x-3">
                    <div
                        class="w-10 h-10 bg-gradient-to-r from-amber-400 to-orange-500 rounded-lg flex items-center justify-center shadow-lg">
                ...
                <p class="text-blue-100 leading-relaxed text-base md:text-lg">
                    Melestarikan keindahan Batik Tanjung Bumi, warisan budaya tak ternilai yang menjadi kebanggaan
                ...
                <div class="flex space-x-3">
                    ...
                    <a href="https://www.instagram.com/kembangpote_batikpaseseh" target="_blank"
                        class="group bg-pink-600 hover:bg-pink-500 w-12 h-12 rounded-xl flex items-center justify-center transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg">
                    ...
                    <a href="https://youtube.com/@kknttanjungbumi?si=GzvhzuFfrCQCklFq" target="_blank"
                        class="group bg-red-600 hover:bg-red-500 w-12 h-12 rounded-xl flex items-center justify-center transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg">
                        <i class="fab fa-youtube text-white group-hover:text-red-100"></i>
                    </a>
                    <a href="mailto:komunitaskembangpote@gmail.com" target="_blank"
                        class="group bg-blue-600 hover:bg-blue-500 w-12 h-12 rounded-xl flex items-center justify-center transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg">
                        <i class="fas fa-envelope text-white group-hover:text-blue-100"></i>
                    </a>
                </div>
            </div>
        </div>
            ...
            <ul class="space-y-4">
                <li>
                    <a href="{{ route('edupackage.index') }}"
                        class="group flex items-center text-blue-100 hover:text-white transition-all duration-300 transform hover:translate-x-2">
                        <i
                            class="fas fa-graduation-cap text-amber-400 mr-3 text-sm group-hover:scale-110 transition-transform"></i>
                        <span class="font-medium">Paket Edukasi</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('shop.index') }}"
                        class="group flex items-center text-blue-100 hover:text-white transition-all duration-300 transform hover:translate-x-2">
                        <i
                            class="fas fa-shopping-cart text-amber-400 mr-3 text-sm group-hover:scale-110 transition-transform"></i>
                ...
                <li>
                    <a href="{{ route('cara-pemesanan') }}"
                        class="group flex items-center text-blue-100 hover:text-white transition-all duration-300 transform hover:translate-x-2">
                        <i
                            class="fas fa-handshake text-amber-400 mr-3 text-sm group-hover:scale-110 transition-transform"></i>
                        <span class="font-medium">Cara Pemesanan</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('perjalanan') }}"
                        class="group flex items-center text-blue-100 hover:text-white transition-all duration-300 transform hover:translate-x-2">
                        <i
                            class="fas fa-route text-amber-400 mr-3 text-sm group-hover:scale-110 transition-transform"></i>
                        <span class="font-medium">Perjalanan</span>
                    </a>
                </li>
            </ul>
        </div>
            ...
            <ul class="space-y-4">
                <li>
                    <a href="{{ route('aboutus') }}"
                        class="group flex items-center text-blue-100 hover:text-white transition-all duration-300 transform hover:translate-x-2">
                        <i
                            class="fas fa-info-circle text-amber-400 mr-3 text-sm group-hover:scale-110 transition-transform"></i>
                        <span class="font-medium">Tentang Kami</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('aboutus') }}#form-card"
                        class="group flex items-center text-blue-100 hover:text-white transition-all duration-300 transform hover:translate-x-2">
                        <i
                            class="fas fa-envelope text-amber-400 mr-3 text-sm group-hover:scale-110 transition-transform"></i>
                ...
                <li>
                    <a href="{{ route('event.index') }}"
                        class="group flex items-center text-blue-100 hover:text-white transition-all duration-300 transform hover:translate-x-2">
                        <i
                            class="fas fa-newspaper text-amber-400 mr-3 text-sm group-hover:scale-110 transition-transform"></i>
                ...
                <li>
                    <a href="{{ route('penghargaan') }}"
                        class="group flex items-center text-blue-100 hover:text-white transition-all duration-300 transform hover:translate-x-2">
                        <i
                            class="fas fa-trophy text-amber-400 mr-3 text-sm group-hover:scale-110 transition-transform"></i>
        ...
        <div class="lg:col-span-1">
            ...
            <ul class="space-y-5">
                <li class="flex items-start group">
                    <div
                        class="bg-blue-700 group-hover:bg-amber-500 w-10 h-10 rounded-lg flex items-center justify-center mt-1 transition-all duration-300 group-hover:scale-110">
                ...
                {{-- <li class="flex items-center group">
                    <div
                        class="bg-blue-700 group-hover:bg-amber-500 w-10 h-10 rounded-lg flex items-center justify-center transition-all duration-300 group-hover:scale-110">
                        <i class="fas fa-envelope text-white text-sm"></i>
                    </div>
                    <div class="ml-4">
                        <p class="font-semibold text-white">Email</p>
                        <a href="mailto:batikpasseeh@gmail.com"
