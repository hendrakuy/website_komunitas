...
<body class="font-sans bg-gray-100 min-h-screen" x-data="navbar()" x-init="initScroll()">
    <header
        ...
        <nav aria-label="Global" class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
            ...
            <!-- Mobile Menu Button - Ubah lg ke xl -->
            ...
            <!-- Desktop Navigation - Ubah lg ke xl -->
    ...
    <script>
        function navbar() {
            return {
                ...
                initScroll() {
                    // inisialisasi dan bind listener scroll ke properti scrolled
