...
@section('content')
    <section class="py-12 bg-gradient-to-br from-amber-50 via-white to-amber-50 min-h-screen">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <!-- Main Card -->
            <div
                class="bg-white rounded-3xl shadow-2xl overflow-hidden transform hover:shadow-2xl transition-all duration-300">
                <!-- Hero Image -->
                ...
                <div class="p-8 lg:p-12">
                    ...
                    <div class="mb-8">
                        ...
                        <p class="text-lg text-gray-600 leading-relaxed max-w-5xl">
                            {{ $package->description }}
                        </p>
                    </div>
                    ...
                    <!-- Price & CTA -->
                    <div
                        class="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-12 p-6 bg-gradient-to-r from-amber-50 to-yellow-50 rounded-2xl border border-amber-200">
                        <div class="mb-4 lg:mb-0">
                            <p class="text-gray-600 text-lg mb-2">Harga Paket</p>
                            <div class="flex items-baseline">
                                <span class="text-2xl md:text-3xl lg:text-4xl font-bold text-amber-700">
                                    Rp {{ number_format($package->price, 0, ',', '.') }}
                                </span>
                                <p class="text-xs md:text-sm text-gray-500 ml-2">
                                    Untuk {{ $package->kapasitas ?? '—' }} orang
                                </p>
                            </div>
                        </div>
                        <a href="{{ $package->whatsapp_link }}" target="_blank"
                            class="inline-flex items-center justify-center w-full lg:w-auto bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white px-6 lg:px-8 py-3 lg:py-4 rounded-xl font-semibold text-base lg:text-lg shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 group">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="w-4 h-4 mr-2 lg:mr-3 group-hover:scale-110 transition-transform" fill="currentColor"
                                viewBox="0 0 24 24">
                                <path
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                        <div
                            ...
                            <p class="text-gray-600 text-sm">Materi terstruktur dari dasar hingga mahir</p>
                        </div>
                        ...
                        <div
                            ...
                            <h3 class="font-semibold text-gray-800 mb-2">Alat Membatik</h3>
                            <p class="text-gray-600 text-sm">Semua peralatan membatik disediakan</p>
                        </div>
                    </div>
                    ...
                    <div class="mt-12 text-center bg-gradient-to-r from-amber-500 to-amber-600 rounded-2xl p-8 text-white">
                        ...
                        <p class="text-amber-100 mb-6 text-lg">Bergabunglah dengan ratusan peserta yang telah merasakan
                            pengalaman membatik tak terlupakan</p>
                        <a href="{{ $package->whatsapp_link }}" target="_blank"
